...
<div class="chat_box">
	<div class="messaging">
      <div class="inbox_msg">
        <div class="mesgs">
          <div class="msg_history" id="content">
          	<?php $this->load->view('chat/table_user_chat_message', array('chat'=>$chat)); ?>
          </div>
          <div class="type_msg">
