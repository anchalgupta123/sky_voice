	...
	<div class="modal-content">
		<form id="uploadForm" data-parsley-validate class="form-horizontal form-label-left">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">Update GK Question</h4>
			...
			<div class="modal-body">
				...
				<div class="form-group row">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="answer1" required="required" class="form-control datepicker col-md-10 col-xs-12" value="<?php echo $gk->answer; ?>" disabled>
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-warning" onclick="update_gk_category();">Save</button>	
			</div>
		</form>
