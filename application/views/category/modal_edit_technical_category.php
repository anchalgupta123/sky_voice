    ...
    <div class="modal-content">
        <form id="uploadForm" data-parsley-validate class="form-horizontal form-label-left">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Update Technical Question</h4>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-warning" onclick="update_technical_category();">Save</button>    
            </div>
        </form>
