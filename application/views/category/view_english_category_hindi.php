...
<html dir="ltr" lang="en">
  <head>
    ...
    <?php $this->load->view('bars/head',array('title'=>'English Category'));?>
  </head>
  <body>
    <div id="main-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row">
              <div class="col-12 d-flex no-block align-items-center">
                  <h4 class="page-title"> English Question </h4>
              </div>
               <h5 style="margin-left:40%;">Total Added Questions : <?php echo $english_hindi_count; ?></h5>
          </div>
        </div>
         <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title" style="margin-left:45%;margin-bottom: 5%;"><b>Add English Questions</b></h5>
                          <div class="form-group row">
                            <label class="col-sm-2 text-right control-label col-form-label" for="first-name">Question <?php echo $english_hindi_count + 1; ?> <span class="required">*</span>
                                      </label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group" style="margin-left: 50%;">
                              <br>
                              <button type="buttons" class="btn btn-primary" onclick="add_english_hindi_question();">Submit</button>
                            </div>
                         </div>
                      </div>
                <div class="container">
                   <h5 class="card-title"><b>View English Question</b></h5>
                   <hr>
                  <div class="row">
                      ...
                      <table id="zero_config" class="table table-striped table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><button class="btn btn-xs btn-warning" onclick="edit_english_hindi_modal('<?php echo $key->id; ?>');">Edit</button> <button class="btn btn-danger btn-xs" onclick="delete_english_hindi_category('<?php echo $key->id;?>');"><i class="fa fa-trash"></i></button></td>
                          </tr>
                          <?php }  } ?>
                        </tbody>
                        </table>
    ...
    <script type="text/javascript">
      function edit_english_hindi_modal(id)
      {
        $.ajax({
          url: base_url+"Category/edit_english_hindi_modal", 
          type : "POST",
          data :{id : id},
