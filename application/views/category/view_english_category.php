...
<html dir="ltr" lang="en">
  ...
  <body>
      ...
      <div class="page-wrapper">
        <div class="page-breadcrumb">
          <div class="row">
              ...
              <h5 style="margin-left:40%;">Total Added Questions : <?php echo $english_count; ?></h5>
          </div>
        </div>
                ...
                <div class="card-body">
                    <h5 class="card-title" style="margin-left:45%;margin-bottom: 5%;"><b>Add English Questions</b></h5>
                          <div class="form-group row">
                            <label class="col-sm-2 text-right control-label col-form-label" for="first-name">Question <?php echo $english_count + 1; ?> <span class="required">*</span>
                                      </label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group" style="margin-left: 50%;">
                              <br>
                              <button type="buttons" class="btn btn-primary" onclick="add_english_question();">Submit</button>
                            </div>
                         </div>
                      </div>
                <div class="container">
                      ...
                      <table id="zero_config" class="table table-striped table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><button class="btn btn-xs btn-warning" onclick="edit_english_modal('<?php echo $key->id; ?>');">Edit</button> <button class="btn btn-danger btn-xs" onclick="delete_english_category('<?php echo $key->id;?>');"><i class="fa fa-trash"></i></button></td>
                          </tr>
                          <?php }  } ?>
                        </tbody>
                        </table>
    ...
    <script type="text/javascript">
      function edit_english_modal(id)
      {
        $.ajax({
          url: base_url+"Category/edit_english_modal", 
          type : "POST",
          data :{id : id},
