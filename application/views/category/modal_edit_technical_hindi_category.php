    ...
    <div class="modal-content">
        <form id="uploadForm" data-parsley-validate class="form-horizontal form-label-left">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Update Technical Hindi Question</h4>
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="question1" required="required" class="form-control datepicker col-md-10 col-xs-12" value="<?php echo $technical->question; ?>" required>
                    </div>
                </div>  
                <div class="form-group row">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="option11" required="required" class="form-control datepicker col-md-10 col-xs-12" value="<?php echo $technical->option1; ?>" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="option22" required="required" class="form-control datepicker col-md-10 col-xs-12" value="<?php echo $technical->option2;?>" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="option33" class="form-control datepicker col-md-10 col-xs-12" value="<?php echo $technical->option3;?>" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="option44" required="required" class="form-control datepicker col-md-10 col-xs-12" value="<?php echo $technical->option4; ?>" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="answer1" required="required" class="form-control datepicker col-md-10 col-xs-12" value="<?php echo $technical->answer; ?>">
                          <input type="hidden" value="<?php echo $technical->id; ?>" id="technical_id">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-warning" onclick="update_technical_hindi_category();">Save</button>    
            </div>
        </form>
