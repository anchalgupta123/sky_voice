...
<html dir="ltr" lang="en">
  ...
  <body>
        ...
        <div class="page-breadcrumb">
          <div class="row">
              <div class="col-12 d-flex no-block align-items-center">
                  <h4 class="page-title"> Technical Questions </h4>
              </div>
              <h5 style="margin-left:40%;">Total Added Questions : <?php echo $technical_count; ?></h5>
          </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                            <label class="col-sm-2 text-right control-label col-form-label" for="first-name">Question  <?php echo $technical_count + 1; ?> <span class="required">*</span>
                                      </label>
                            <div class="col-sm-10">
                   ...
                   <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group" style="margin-left: 50%;">
                        <br>
                        <button type="buttons" class="btn btn-primary" onclick="add_technical_question();">Submit</button>
                      </div>
                   </div>
                </div>
                <div class="container">
                      ...
                      <table id="zero_config" class="table table-striped table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><button class="btn btn-xs btn-warning" onclick="edit_technical_modal('<?php echo $key->id; ?>');">Edit</button> <button class="btn btn-danger btn-xs" onclick="delete_technical_category('<?php echo $key->id;?>');"><i class="fa fa-trash"></i></button></td>
                          </tr>
                          <?php }  } ?>
                        </tbody>
                        </table>
    ...
    <script type="text/javascript">
      function edit_technical_modal(id)
      {
        $.ajax({
          url: base_url+"Category/edit_technical_modal", 
          type : "POST",
          data :{id : id},
